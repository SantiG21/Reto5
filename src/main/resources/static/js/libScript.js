...
function getFrontLibData(){
    let k={
        ...
        capacity:$("#capacityMotorbike").val(),
        target:$("#targetMotorbike").val(),
...
function getLibById(idLib){
    ...
    $.ajax({
        ...
        success : function(p) {
            console.log(p);
            $("#idMotorbike").val(p.id);
            $("#nameMotorbike").val(p.name);
            $("#capacityMotorbike").val(p.capacity);
            $("#targetMotorbike").val(p.target);
            $("#descriptionMotorbike").val(p.description);
